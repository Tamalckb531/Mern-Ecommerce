...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'ckbtamaldipnew@gmail.com', // gmail
    pass: 'agsq ytvx nqjw laps', // pass
  },
});
...
exports.cookieExtractor = function (req) {
  ...
  // token ="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1MmQ0ODRkYWVmNTUwNjRmZjQzMWU3MSIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTY5NzQ2NjUzMX0.IUojiq3sHxa890X6rc4J7XcQgCoMfJtXh26kBsFrnGo"
  return token;
};

exports.sendMail = async function ({ to, subject, text, html }) {
  let info = await transporter.sendMail({
    from: '"E-commerce" <ckbtamaldipnew@gmail.com>', // sender address
    to,
    subject,
    text,
    html
